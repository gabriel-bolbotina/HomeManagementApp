...
class HomeownerNotificationSettingsWidget extends StatefulWidget {
  const HomeownerNotificationSettingsWidget({Key? key}) : super(key: key);

  @override
  _HomeownerNotificationSettingsWidgetState createState() =>
      _HomeownerNotificationSettingsWidgetState();
}

class _HomeownerNotificationSettingsWidgetState
    extends State<HomeownerNotificationSettingsWidget> {
